...
const SPRITE_PACK_SPRITES4: SpritePack = {
  ...
  denseVariants: {
    ...
    // Commercial high density (mall) - requested dense variants only
    // (0-indexed row/col): (3,1), (2,2), (2,3), (2,4)
    mall: [
      { row: 3, col: 1 },
      { row: 2, col: 2 },
      { row: 2, col: 3 },
...
// ============================================================================
// SPRITE PACK: SPRITES4 MODERN AGE (CityLife)
// ============================================================================
// Uses the age-sheet artwork and keeps selection inside that sheet.
const SPRITE_PACK_SPRITES4_MODERN_AGE: SpritePack = {
  ...SPRITE_PACK_SPRITES4,
  id: 'sprites4-ages-modern',
  name: 'Modern Age',
  src: '/assets/ages/modern.png',
  constructionSrc: '/assets/ages/modern.png',
  abandonedSrc: '/assets/ages/modern.png',
  denseSrc: '/assets/ages/modern.png',
  modernSrc: '/assets/ages/modern.png',
  // Keep CityLife visuals on the requested modern age sheet only.
  parksSrc: undefined,
  parksConstructionSrc: undefined,
  farmsSrc: undefined,
  shopsSrc: undefined,
  servicesSrc: undefined,
  infrastructureSrc: undefined,
...
export const SPRITE_PACKS: SpritePack[] = [
  ...
  SPRITE_PACK_SPRITES4_MODERN_AGE,
];
